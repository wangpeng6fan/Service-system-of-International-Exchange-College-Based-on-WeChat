		...
		<div id="sidebar">
            <ul>
                ...
                <li  class="current"><a href="#"><img src="${ctx}/img/icons/menu/factory.png" alt="" /> 疑难问题管理</a>
                    <ul>
                    	<c:if test="${count eq '校内'}">
                        <li class="current"><a href="${ctx}/ynjd/list?count=校内">校内专区</a></li>
                    	</c:if>
                    	<c:if test="${count != '校内'}">
                        <li><a href="${ctx}/ynjd/list?count=校内">校内专区</a></li>
                    	</c:if>
                    	<c:if test="${count eq '国外'}">
                        <li class="current"><a href="${ctx}/ynjd/list?count=国外">国外专区</a></li>
                        </c:if>
                    	<c:if test="${count != '国外'}">
                        <li><a href="${ctx}/ynjd/list?count=国外">国外专区</a></li>
                        </c:if>
                        <c:if test="${count eq '新生'}">
                        <li class="current"><a href="${ctx}/ynjd/list?count=新生">新生专区</a></li>
                        </c:if>
                        <c:if test="${count != '新生'}">
                        <li><a href="${ctx}/ynjd/list?count=新生">新生专区</a></li>
                        </c:if>
                        <c:if test="${count eq '常见'}">
                        <li current><a href="${ctx}/ynjd/list?count=常见">常见问题专区</a></li>
                        </c:if>
                        <c:if test="${count != '常见'}">
